...
- [ ] **Step 1: Write the failing identity regression tests.**
...
- [ ] **Step 3: Implement the minimal validated value object.**
...
- [ ] **Step 4: Make the new tests pass and run the focused Core target.**
...
- [ ] **Step 5: Commit the canonical identity unit.**
...
- [ ] **Step 1: Add RED tests for Prepare completion and Task State parity.**
...
- [ ] **Step 3: Resolve identity once at Prepare ingress.**
...
- [ ] **Step 4: Replace Task State's private hash and pass identity through context.**
...
- [ ] **Step 6: Commit Prepare and Task State wiring.**
...
- [ ] **Step 2: Run the hook tests to observe RED.**
...
- [ ] **Step 3: Resolve and propagate one identity in `handle_hook`.**
...
- [ ] **Step 4: Verify hook parity and existing idempotency.**
...
- [ ] **Step 5: Commit native hook parity.**
...
- [ ] **Step 1: Add RED plan and CLI tests.**
...
- [ ] **Step 3: Add identity-aware plan entry point and preserve legacy behavior.**
...
- [ ] **Step 5: Verify plan persistence, no-write failure, resume isolation, and CLI behavior.**
...
- [ ] **Step 6: Commit plan and CLI wiring.**
...
- [ ] **Step 1: Record the SPEC-01 closure and SPEC-02 checkpoint.**
...
- [ ] **Step 2: Run all required focused and repository checks.**
...
- [ ] **Step 3: Perform a final self-review against the acceptance checklist.**
...
- [ ] **Step 4: Commit the maintained documentation and push the complete SPEC-02 branch once.**
